      ...
      >
        ...
        <div className="mini-chord-diagram">
          <svg viewBox="0 0 100 130" className="mini-svg">
            ...
            {startFret > 1 && (
              <text x="8" y="32" fontSize="9" fill="rgba(255,255,255,0.9)" fontWeight="bold">
                {startFret}
              </text>
            )}
        ...
        {chordData.position && <div className="variation-position">{chordData.position}</div>}
      </div>
    )
  }
  ...
  return (
    <div className="chord-variation-picker-overlay" onClick={onClose}>
      <div className="chord-variation-picker" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="variations-grid">{variations.map((variation, index) => renderMiniChord(variation, index))}</div>
