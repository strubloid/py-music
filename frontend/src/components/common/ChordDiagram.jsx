...
const CHORD_FINGERINGS = {
  'C': { frets: [0, 1, 0, 2, 3, 0], fingers: [0, 1, 0, 2, 3, 0], name: 'C Major' },
  'D': { frets: [2, 2, 0, 2, 3, 2], fingers: [1, 1, 0, 2, 3, 1], name: 'D Major' },
  ...
  'A': { frets: [0, 0, 2, 2, 2, 0], fingers: [0, 0, 1, 2, 3, 0], name: 'A Major' },
  'B': { frets: [2, 2, 4, 4, 4, 2], fingers: [1, 1, 2, 3, 4, 1], name: 'B Major' },
  
  // Minor chords
  'Cm': { frets: [0, 1, 3, 3, 2, 0], fingers: [0, 1, 4, 3, 2, 0], name: 'C Minor' },
  'Dm': { frets: [1, 0, 0, 2, 3, 1], fingers: [1, 0, 0, 2, 3, 1], name: 'D Minor' },
  'Em': { frets: [0, 2, 2, 0, 0, 0], fingers: [0, 2, 3, 0, 0, 0], name: 'E Minor' },
  'Fm': { frets: [1, 3, 3, 1, 1, 1], fingers: [1, 3, 4, 1, 1, 1], name: 'F Minor' },
  'Gm': { frets: [3, 1, 0, 0, 3, 3], fingers: [3, 1, 0, 0, 3, 4], name: 'G Minor' },
  'Am': { frets: [0, 0, 2, 2, 1, 0], fingers: [0, 0, 2, 3, 1, 0], name: 'A Minor' },
  'Bm': { frets: [2, 2, 4, 4, 3, 2], fingers: [1, 1, 3, 4, 2, 1], name: 'B Minor' },
  
  // 7th chords
  'C7': { frets: [0, 1, 0, 2, 1, 0], fingers: [0, 1, 0, 3, 2, 0], name: 'C Dominant 7' },
  'D7': { frets: [2, 0, 0, 2, 1, 2], fingers: [2, 0, 0, 3, 1, 2], name: 'D Dominant 7' },
  ...
  'A7': { frets: [0, 0, 2, 0, 2, 0], fingers: [0, 0, 2, 0, 3, 0], name: 'A Dominant 7' },
  'B7': { frets: [2, 0, 1, 2, 0, 2], fingers: [2, 0, 1, 3, 0, 4], name: 'B Dominant 7' }
}
