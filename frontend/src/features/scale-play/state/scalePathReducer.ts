...
export const isScalePathInputLocked = (state: ScalePathState) => state.inputLocked || LOCKED_PHASES.has(state.phase)

export const createInitialScalePathState = (
  opts: { reducedMotion?: boolean; challengeCount?: number } = {},
): ScalePathState => ({
  phase: 'loading',
  resumePhase: null,
...
export const scalePathReducer = (
  state: ScalePathState,
